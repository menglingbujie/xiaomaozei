...
// 项目源码路径
var SRC_PATH = ROOT_PATH + '/webapp';
// 产出路径
var DIST_PATH = ROOT_PATH + '/public/dist';
...
var config = {
  ...
  output: {
    ...
    filename: __DEV__ ? 'js/[name].js' : 'js/[name].[chunkhash:7].js',
    chunkFilename: __DEV__ ? 'js/[name].js' : 'js/[name].[chunkhash:7].js'
  },
  module: {},
  resolve: {
    root: SRC_PATH,
